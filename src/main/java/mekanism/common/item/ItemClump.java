...
public class ItemClump extends ItemMekanism implements IMetaItem {
    ...
    public String getTexture(int meta) {
        return MekanismUtils.getByIndex(Resource.values(), meta, Resource.IRON).getName() + "Clump";
    }
    ...
    public String getTranslationKey(ItemStack item) {
        ...
        return resource == null ? "Invalid" : "item." + resource.getName().toLowerCase(Locale.ROOT) + "Clump";
    }
}
