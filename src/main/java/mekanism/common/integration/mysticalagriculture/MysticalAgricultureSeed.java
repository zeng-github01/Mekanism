        ...
        for (String name : names) {
            ...
            if (seeds != ItemStack.EMPTY){
                if (!RecipeHandler.Recipe.ORGANIC_FARM.containsRecipe(seeds) && !RecipeHandler.Recipe.ORGANIC_FARM.containsRecipe(essence)) {
                    RecipeHandler.addOrganicFarmRecipe(seeds, MekanismFluids.NutrientSolution, essence, seeds, MekanismConfig.current().mekce.seed.val());
                }
            }
        }
        for (int i = 1; i <= 5; i++) {
            ...
            if (seeds != ItemStack.EMPTY) {
                if (!RecipeHandler.Recipe.ORGANIC_FARM.containsRecipe(seeds)) {
                    RecipeHandler.addOrganicFarmRecipe(seeds, MekanismFluids.NutrientSolution, getItemStack("crafting", i * 4, 0), seeds, MekanismConfig.current().mekce.seed.val());
                }
            }
        }
        ...
        if (Loader.isModLoaded("mysticalagradditions")) {
            ...
            if (tier6seeds != ItemStack.EMPTY) {
                if (!RecipeHandler.Recipe.ORGANIC_FARM.containsRecipe(tier6seeds)) {
                    RecipeHandler.addOrganicFarmRecipe(tier6seeds, MekanismFluids.NutrientSolution, getItemStack("crafting", 6 * 4, 0), tier6seeds, MekanismConfig.current().mekce.seed.val());
                }
            }
        }
    }
