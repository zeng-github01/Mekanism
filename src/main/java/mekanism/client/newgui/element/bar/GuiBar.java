...
public abstract class GuiBar<INFO extends IBarInfoHandler> extends GuiTexturedElement {
    ...
    public void drawBackground(int mouseX, int mouseY, float partialTicks) {
        ...
        if (warning) {
            ...
            blit(x + 1, y + 1, 0, 0, width - 2, height - 2, 256, 256);
        }
        //Render Contents
        ...
        if (handlerLevel > 0) {
            ...
            if (warning && handlerLevel == 1) {
                ...
                if (horizontal) {
                    ...
                    blit( x + 1, y + 1 + halfHeight, 0, halfHeight, width - 2, halfHeight, 256, 256);
                } else {//vertical
                    int halfWidth = (width - 2) / 2;
                    blit( x + 1 + halfWidth, y + 1, halfWidth, 0, halfWidth, height - 2, 256, 256);
                }
            }
        }
    }
