...
public class ModelMekafishingRodleft extends ModelBase {
    ...
    public ModelMekafishingRodleft() {
        ...
        wheel_handle_r1.cubeList.add(new ModelBox(wheel_handle_r1, 20, 0, 1.5F, -1.5F, 0.5F, 2, 1, 1, 0.0F, false));
        wheel_handle_r1.cubeList.add(new ModelBox(wheel_handle_r1, 4, 0, 0.5F, -1.5F, -1.5F, 1, 3, 3, 0.0F, false));
        wheel_handle_r1.cubeList.add(new ModelBox(wheel_handle_r1, 4, 0, -1.5F, -1.5F, -1.5F, 1, 3, 3, 0.0F, false));
        ...
        intelligent_module.cubeList.add(new ModelBox(intelligent_module, 12, 0, -2.0F, -11.0F, -1.0F, 2, 3, 2, 0.0F, false));
    ...
    public void renderBait(float size) {
        bait_module.render(size);
    }

    public void renderIntelligent(float size) {
        intelligent_module.render(size);
    }

    public void renderCollection(float size) {
        collection_module.render(size);
    }

    public void renderCatching(float size) {
