...
public class GuiChemicalOxidizer extends GuiMekanismTile<TileEntityChemicalOxidizer> implements IJeiNoShowRecipe {
    ...
    public GuiChemicalOxidizer(InventoryPlayer inventory, TileEntityChemicalOxidizer tile) {
        ...
        addGuiElement(new GuiEnergySlot(this, resource, 153, 13, tileEntity));
        addGuiElement(new GuiInputSlot( this, resource, 25, 35, tileEntity));
        addGuiElement(new GuiOutputSlot( this, resource, 153, 54, tileEntity).with(SlotOverlay.PLUS));
