...
public class GuiIsotopicCentrifuge extends GuiMekanismTile<TileEntityIsotopicCentrifuge> implements IJeiNoShowRecipe {
    ...
    public GuiIsotopicCentrifuge(InventoryPlayer inventory, TileEntityIsotopicCentrifuge tile) {
        ...
        addGuiElement(new GuiInputSlot(this, resource, 4, 55, tileEntity).with(SlotOverlay.MINUS));
        addGuiElement(new GuiOutputSlot(this, resource, 154, 55, tileEntity).with(SlotOverlay.PLUS));
