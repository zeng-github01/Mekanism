...
public class GuiHeatInfo extends GuiElement {
    ...
    public GuiHeatInfo(IInfoHandler handler, IGuiWrapper gui, ResourceLocation def) {
        super(MekanismUtils.getResource(ResourceType.TAB, "Heat_Info.png"), gui, def);
        infoHandler = handler;
    }

    @Override
    public Rectangle4i getBounds(int guiWidth, int guiHeight) {
        return new Rectangle4i(guiWidth - 26, guiHeight + 112, 26, 26);
    }
    ...
    public void renderBackground(int xAxis, int yAxis, int guiWidth, int guiHeight) {
        ...
        guiObj.drawTexturedRect(guiWidth - 21, guiHeight + 116, 26 + 18 * outputOrdinal, 0, 18, 18);
