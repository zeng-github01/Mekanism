...
public class RenderLargeElectrolyticSeparatorItem extends MekanismItemStackRenderer {

    public static ItemLayerWrapper model;

    private static ModelLargeElectrolyticSeparator cube = new ModelLargeElectrolyticSeparator();
    ...
    protected void renderBlockSpecific(@NotNull ItemStack stack, TransformType transformType) {
        ...
        MekanismRenderer.bindTexture(MekanismUtils.getResource(MekanismMultiblockMachine.MODID,ResourceType.RENDER_MACHINE,"ElectrolyticSeparator/ElectrolyticSeparator.png"));
