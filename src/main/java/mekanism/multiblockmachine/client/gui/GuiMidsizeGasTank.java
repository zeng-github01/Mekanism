...
public class GuiMidsizeGasTank extends GuiMekanismTile<TileEntityMidsizeGasTank> {
    ...
    public GuiMidsizeGasTank(InventoryPlayer inventory,TileEntityMidsizeGasTank tile) {
        ...
        addGuiElement(new GuiInputSlot( this, resource, 15, 16, tileEntity).with(GuiSlot.SlotOverlay.PLUS));
        addGuiElement(new GuiOutputSlot(this, resource, 15, 46, tileEntity).with(GuiSlot.SlotOverlay.MINUS));
