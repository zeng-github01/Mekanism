...
public abstract class ContainerFuelMultiBlockGenerator<TILE extends TileEntityElectricBlock> extends ContainerMekanism<TILE> {

    protected ContainerFuelMultiBlockGenerator(InventoryPlayer inventory, TILE tile) {
