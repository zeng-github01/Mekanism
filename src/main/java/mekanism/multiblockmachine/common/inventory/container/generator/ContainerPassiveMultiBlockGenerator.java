...
public abstract class ContainerPassiveMultiBlockGenerator<TILE extends TileEntityElectricBlock> extends ContainerMekanism<TILE> {

    protected ContainerPassiveMultiBlockGenerator(InventoryPlayer inventory, TILE tile) {
